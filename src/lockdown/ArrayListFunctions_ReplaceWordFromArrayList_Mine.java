...
public class ArrayListFunctions_ReplaceWordFromArrayList_Mine {
	int count=0;
	...
	void replaceWordInArrayList(ArrayList<String> arrayList, String removeWord, String replaceWith) {
		...
		for (int index=0; index<arrayList.size(); index++) {
			if (arrayList.get(index).equals(replaceWith))
				count++;
		}
	...
	public static void main(String[] args) {
		...
		new ArrayListFunctions_ReplaceWordFromArrayList_Mine().replaceWordInArrayList(arrayList, removeWord, replaceWith);
	}
}	
